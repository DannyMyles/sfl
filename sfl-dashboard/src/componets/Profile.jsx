...
const Profile = ({ dialogVisible, hideDialog }) => {
  ...
  return (
    <div className="relative bg-[#F9F9FB] p-2.5 rounded-md">
      <Dialog
        ...
        appendTo={document.body} // Ensure it appends to body
        style={{ width: "30vw", zIndex: 1000 }} // Explicit z-index
        breakpoints={{ "960px": "75vw", "641px": "100vw" }}
        className="bg-[#F9F9FB] p-2.5 rounded-md"
